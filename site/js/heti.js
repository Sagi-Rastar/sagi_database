...
(function (global, factory) {
              ...
              if (!endPortion && curNode.length + atIndex >= match.endIndex) {
                ...
                endPortion = {
                  ...
                  text: curNode.data.substring(
                    match.startIndex - atIndex + this.options.offset,
  ...
  const HETI_NON_CONTIGUOUS_ELEMENTS = Object.assign(
    {},
  ...
  const HETI_SKIPPED_ELEMENTS = Object.assign(
    {},
    findAndReplaceDOMText.NON_PROSE_ELEMENTS,
    {
      pre: 1,
      code: 1,
      sup: 1,
    ...
    spacingElement($$elm) {
      ...
      findAndReplaceDOMText(
        ...
        Object.assign({}, commonConfig, {
          ...
          replace: (portion) =>
            getWrapper("heti-adjacent", "heti-adjacent-half", portion.text),
          offset: this.offsetWidth,
        })
      );
      ...
      findAndReplaceDOMText(
        ...
        Object.assign({}, commonConfig, {
          ...
          replace: (portion) =>
            getWrapper("heti-adjacent", "heti-adjacent-quarter", portion.text),
          offset: this.offsetWidth,
        })
      );
